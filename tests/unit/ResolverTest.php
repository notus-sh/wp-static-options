...
class ResolverTest extends TestCase
{
    ...
    public function testGetBackendOption()
    {
        ...
        $resolver = new Resolver(new Set([]), function ($name, $default) {
            $this->assertTrue(Resolver::inFilter());
    ...
    {
        $resolver = new Resolver(new Set([]), function () {
    ...
    {
        $set = Set::from(TESTS_DATA . '/config/resolver');
        $resolver = new Resolver($set, function () {
            throw new RuntimeException('Callback should not have been called.');
        });
    ...
    {
        $set = Set::from(TESTS_DATA . '/config/resolver');
        $resolver = new Resolver($set, function ($name, $default) {
            return $default;
        });
